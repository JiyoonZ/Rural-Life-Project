...
<body>
	...
	<div class="favourite-place section-padding2">
		<div class="container">
			...
			<form method="POST" action="/rural/farm/editok.do" enctype="multipart/form-data">
				<table class="table table-bordered" id="addform">
					...
					<tr>
						<td colspan="4">
							<textarea name="detail" id="detail" class="form-control" maxlength="1000" required>${dto.detail}</textarea>
						</td>
					</tr>
				</table>
				<div style="text-align: right;">
					<input type="checkbox" name="isEnd" value="y" id="isEnd"> 마감
				</div>
				...
				<input type="hidden" name="orgImage" value="${dto.image}">
			</form>
	...
	<script>
		...
		$('document').ready(function() {
			...
			<c:if test="${dto.isEnd.equals('y')}">
				$("input:checkbox[id='isEnd']").prop("checked", true);
			</c:if>
		});
